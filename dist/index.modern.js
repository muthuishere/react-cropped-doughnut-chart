...
function createArc({
  ...
  const chartPath = createElement('path', [['fill', color], ['class', 'path-container'], ['stroke-width', '0']]);
...
function createTextElement(textId, {
  ...
  const textPathElement = createElement('textPath', [['href', '#' + textId], ['text-anchor', 'top'], ['startOffset', '0%']]);
...
function DoughnutElement(items, {
  radius,
  title,
  thicknessSize,
  gapSize,
